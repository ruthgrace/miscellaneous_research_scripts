...
OUTPUTFOLDER="/Groups/assembly/PRICEoutput10to20coverageseeds/"

SEEDSTART="/Groups/assembly/PRICEoutput10to20coverageseeds/seeds/"
SEEDEND=".fasta"

for i in $SAMPLE
	do
		/Groups/assembly/bin/PriceSource130506/PriceTI -fpp $INPUTFOLDER$SAMPLESTART$ONE$i$SAMPLEEND $INPUTFOLDER$SAMPLESTART$TWO$i$SAMPLEEND 500 95 -icf $SEEDSTART$i$SEEDEND 1 1 5 -nc 30 -dbmax 72 -mol 30 -tol 20 -mpi 80 -target 90 2 1 1 -o $OUTPUTFOLDER$i.fasta
	done
